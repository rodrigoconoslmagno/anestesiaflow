...
import { AppCardsPlantaoNoturno } from "@/componentes/plantao/AppCardsPlantaoNorurno";
    ...
    const StaticCell = ({ alocacao, hora }: { alocacao?: EscalaItem, hora: string, plantao: boolean }) => {
        ...
        useEffect(() => {
            ...
            try {
                ...
                if (!(dataAtiva.getDay() === 0 || dataAtiva.getDay() === 6)) {
                    setAtivaPlantao(await await server.api.postCustomizada<boolean>('/sudoku', '/templantaodiasemana', { data: dataFormatada }))
                  }
            } catch (error) {
            ...
            <div className="flex flex-col h-screen bg-slate-50 overflow-hidden">
                <header className="flex items-center justify-between sm:px-4 sm:py-3 px-2 py-1 bg-white border-b border-slate-200 shadow-sm z-20">
                    <div className="flex justify-between items-center gap-2 w-full">
                        ...
                        <h1 className="text-[9px] sm:text-xl font-black text-slate-700 m-0 w-auto">
                            Sudoku Diário
                        </h1>

                        <div className="flex items-center justify-between bg-slate-50 border-b border-slate-200 w-full">
                            <Button 
                ...
                <main className="flex-col sm:!p-2 !p-0 overflow-auto">
                    ...
                    <AppCardsPlantaoNoturno className='' dataAtual={dataAtiva} />
                </main>
            </div>
        )
    }